...
function loadEditorialProfiles(){
  ...
  if(!document.querySelector('script[data-setari-andrei]')){
    const a=document.createElement('script');a.src=assetPath('andrei-bonamigo.js?v=20260820-1');a.defer=true;a.dataset.setariAndrei='1';document.head.appendChild(a);
  }
  if(!document.querySelector('script[data-setari-nilmara]')){
    const n=document.createElement('script');n.src=assetPath('nilmara-guimaraes.js?v=20260820-1');n.defer=true;n.dataset.setariNilmara='1';document.head.appendChild(n);
  }
}
function loadI18n(){
  if(document.querySelector('script[data-setari-i18n-v2]'))return;
  const s=document.createElement('script');s.src=assetPath('i18n-v2.js?v=20260820-1');s.defer=true;s.dataset.setariI18nV2='1';
  s.onload=()=>{const f=document.createElement('script');f.src=assetPath('i18n-fixes.js?v=20260820-1');f.defer=true;f.dataset.setariI18nFixes='1';f.onload=()=>{if(window.SETARI_I18N?.apply)window.SETARI_I18N.apply();if(window.SETARI_I18N_FIXES?.apply)window.SETARI_I18N_FIXES.apply();};document.head.appendChild(f)};
