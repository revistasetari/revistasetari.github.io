...
function fixEditorialPhotoPresentation(){
 ...
 .eb .grid .card .photo{width:146px!important;height:220px!important;min-height:220px!important;max-height:220px!important;object-fit:contain!important;object-position:center top!important;padding:10px!important;margin:14px 0 14px 14px!important;align-self:start!important;border-radius:10px!important;background:#f4f8f7!important;box-sizing:border-box!important;box-shadow:inset 0 0 0 1px #e2ebeb!important}
 .eb .reviewers .rev{grid-template-columns:100px minmax(0,1fr) auto!important;align-items:start!important}
 .eb .reviewers .rev>img,.eb .reviewers .rev>.mono{width:100px!important;height:118px!important;min-height:118px!important;max-height:118px!important;object-fit:contain!important;object-position:center top!important;padding:6px!important;margin:0!important;border-radius:8px!important;background:#f4f8f7!important;box-sizing:border-box!important}
 ...
 @media(max-width:640px){
   ...
   .eb .grid .card .photo{width:min(240px,calc(100% - 28px))!important;height:260px!important;min-height:260px!important;max-height:260px!important;margin:14px auto 0!important;padding:10px!important;object-fit:contain!important;object-position:center top!important}
   .eb .reviewers .rev{grid-template-columns:74px minmax(0,1fr)!important;gap:.75rem!important}
   .eb .reviewers .rev>img,.eb .reviewers .rev>.mono{width:74px!important;height:88px!important;min-height:88px!important;max-height:88px!important;padding:4px!important}
